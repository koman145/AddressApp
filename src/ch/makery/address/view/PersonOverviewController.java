...
public class PersonOverviewController {
	...
	/**
	 * 연락처의 자세한 정보를 보여주기 위해 모든 텍스트 필드를 채운다. 만일 person이 null이면 모든 텍스트 필드가 지워진다.
	 *
	 * @param person
	 *            the person or null
	 */
	...
	/**
	 * 사용자가 new 버튼을 클릭할 때 호출된다. 새로운 연락처 정보를 넣기 위해 다이얼로그를 연다.
	 */
	@FXML
	...
	/**
	 * 사용자가 edit 버튼을 클릭할 때 호출된다. 선택한 연락처 정보를 변경하기 위해 다이얼로그를 연다.
	 */
	@FXML
